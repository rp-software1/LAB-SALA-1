...
export default function PlatoCard({ plato }: PlatoCardProps) {
  ...
  const btnClass = agregado
    ? 'bg-green-600 text-white px-4 py-2 rounded text-sm transition-colors'
    : 'bg-blue-600 text-white px-4 py-2 rounded text-sm hover:bg-blue-700 transition-colors';
